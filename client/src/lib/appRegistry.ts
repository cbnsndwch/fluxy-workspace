...
export const APPS: AppConfig[] = [
    ...
    },
    {
        ...
        name: 'Flow Capture',
        description:
            'Speak your user flow — AI renders it as a live Mermaid diagram',
        icon: GitBranch,
    ...
    },
    {
        ...
        navLabel: 'Versions',
        description:
            'Read-only git history — commits, branches, worktrees & uncommitted changes',
        icon: History,
    ...
    },
    {
        ...
        name: 'Uploads',
        description:
            'Browse all files uploaded via chat — images and documents',
        icon: Paperclip,
    ...
    },
    {
        ...
        name: 'Schedules',
        description:
            'Manage cron jobs, monitor background processes, and review logs',
        icon: Clock,
        color: 'bg-violet-500/10 text-violet-500',
        path: '/schedules',
        section: 'workspace'
    },
    {
        ...
        description:
            'AI-generated conversation starters from live tech headlines',
    ...
    },
    {
        ...
        name: 'Ontologica',
        description:
            'AI-powered ontology mapping — upload documents, extract knowledge graphs',
        icon: Brain,
        color: 'bg-emerald-500/10 text-emerald-500',
        path: '/ontologica',
        section: 'main'
