                ...
                {step === 'form' ? (
                    <>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Create a short-lived token the buyer pastes to
                                their Fluxy to install the selected apps.
                            </DialogDescription>
                        </DialogHeader>
                    ...
                    <>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Share this with the buyer. Expires in{' '}
                                <strong>{timeLeft(expiresAt)}</strong>.
                            </DialogDescription>
                        </DialogHeader>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="rounded-lg border bg-muted/30 p-4">
                                ...
                                <p className="text-xs text-muted-foreground mt-2">
                                    The buyer opens their Fluxy chat and pastes
                                    this. Sebastian handles the rest.
                                </p>
                            </div>
...
function StoreTab() {
    ...
    const maxApps =
        selectedTier.appCount === 'all' ? APPS.length : selectedTier.appCount;
    ...
    return (
        <div className="flex flex-col h-full">
                ...
                <div className="max-w-4xl mx-auto w-full px-6 py-8 space-y-10">
                    ...
                    <div className="text-center py-2">
                        ...
                        <p className="text-muted-foreground max-w-lg mx-auto">
                            Choose a plan, select apps, and give customers a
                            token to install them instantly on their Fluxy.
                        </p>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                            {APPS.map(app => {
                                const isSelected =
                                    allSelected || selectedApps.has(app.id);
                                const isDisabled =
                                    !allSelected &&
                                    !isSelected &&
                                    selectedApps.size >= maxApps;
                    ...
                    <div className="flex-1 min-w-0">
                        {allSelected ? (
                            ...
                            <span className="text-sm text-muted-foreground">
                                Select {maxApps} app{maxApps !== 1 ? 's' : ''}{' '}
                                to generate a token
                            </span>
                        ) : (
                            <div>
            ...
            <CheckoutDialog
                ...
                tier={selectedTier}
                selectedApps={
                    allSelected ? APPS.map(a => a.id) : Array.from(selectedApps)
                }
...
function ReportsTab({ settings }: { settings: MarketplaceSettings | null }) {
    ...
    useEffect(() => {
        ...
        Promise.all([
            hasError
                ? fetch('/app/api/marketplace/error-reports').then(r =>
                      r.json()
                  )
                : Promise.resolve([]),
            hasTelemetry
                ? fetch('/app/api/marketplace/telemetry-events').then(r =>
                      r.json()
                  )
                : Promise.resolve([])
        ]).then(([errors, events]) => {
            ...
            <div className="flex flex-col items-center justify-center h-48 text-center gap-3 p-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                        Enable error tracking or telemetry in Settings to see
                        incoming reports.
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-2xl space-y-8">
                ...
                <div>
                    ...
                    <p className="text-xs text-muted-foreground mb-3">
                        Your workspace ID is attached to incoming error reports
                        and telemetry so you can group them by source.
                    </p>
                    <div className="flex items-center gap-2">
                ...
                <div>
                    ...
                    <p className="text-xs text-muted-foreground mb-4">
                        Apps installed from your marketplace can optionally send
                        data back here. All features are{' '}
                        <strong>off by default</strong> — buyers opt in during
                        install.
                    </p>
                    ...
                    <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <Switch
                                        ...
                                        onCheckedChange={v =>
                                            setForm(f => ({
                                                ...f,
                                                error_tracking_enabled: v
                                            }))
                                        }
                                    />
                                </div>
                                <p className="text-xs text-muted-foreground mt-1">
                                    Buyers' apps send error reports (message +
                                    stack trace) to this workspace. View them in
                                    the Reports tab. Use this to find and fix
                                    bugs in your apps.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4 p-4 rounded-lg border bg-card">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-muted-foreground mt-1">
                                    Apps send anonymous usage events (e.g.
                                    "contact.created", "report.generated").
                                    Helps you understand how buyers use your
                                    apps and prioritize improvements.
                                </p>
                            </div>
                        </div>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <Switch
                                        ...
                                        onCheckedChange={v =>
                                            setForm(f => ({
                                                ...f,
                                                api_reporting_enabled: v
                                            }))
                                        }
                                    />
                                </div>
                                <p className="text-xs text-muted-foreground">
                                    Forward incoming error reports to an
                                    external URL (Sentry, your own API, etc.).
                ...
                <div>
                    ...
                    <p className="text-xs text-muted-foreground mb-3">
                        Add this to any app to support reporting. The functions
                        are silent no-ops when the buyer hasn't opted in.
                    </p>
