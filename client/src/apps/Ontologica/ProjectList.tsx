            ...
            <div className="flex-1 flex items-center justify-center p-8">
                <div className="text-center max-w-md">
                    ...
                    <p className="text-muted-foreground mb-6">
                        Create your first ontology project. Upload documents
                        about your business domain and let AI extract a formal
                        knowledge graph — concepts, relationships, and
                        hierarchies.
                    </p>
                    <button
                        onClick={onNew}
                        ...
                        <CardContent className="p-5">
                            ...
                            <div className="flex items-center gap-4 text-xs text-muted-foreground">
                                <span className="flex items-center gap-1">
                                    <FileText size={12} /> {p.doc_count ?? 0}{' '}
                                    docs
                                </span>
                                <span className="flex items-center gap-1">
                                    <GitBranch size={12} /> {p.node_count}{' '}
                                    concepts
                                </span>
                                <span className="flex items-center gap-1">
                                    <Share2 size={12} /> {p.edge_count}{' '}
                                    relations
                                </span>
                            </div>
                        </CardContent>
