...
export const OntologyNode = memo(function OntologyNode({ data }: NodeProps) {
    ...
    return (
        <div
            ...
            style={{
                opacity:
                    d.status === 'rejected' ? 0.35 : isBaseLayer ? 0.85 : 1,
        ...
        >
            <Handle
                ...
                className="!bg-emerald-500/60 !w-1.5 !h-1.5 !border-0"
            />
            ...
            <div className="px-2.5 py-1.5">
                ...
                <div className="flex items-center gap-1.5">
                    ...
                    {isBaseLayer && (
                        <span
                            className="shrink-0 flex items-center gap-0.5 px-1 py-0.5 rounded bg-cyan-500/15 text-cyan-400 text-[8px] font-medium leading-none"
                            title={d.layerName}
                        >
                            <Layers size={7} />
