...
export default function ImageGenPage() {
    ...
    const [currentImage, setCurrentImage] = useState<Generation | null>(
    ...
    const [gallerySelected, setGallerySelected] = useState<Generation | null>(
        null
    );
    ...
    return (
        ...
        >
            <div className="flex h-full overflow-hidden bg-background">
                ...
                <div
                    className={cn(
                        'w-72 shrink-0 flex flex-col border-r border-border bg-card/40 overflow-hidden',
                        viewMode === 'gallery' && 'hidden'
                    )}
                >
                                ...
                                {referenceImage ? (
                                    ...
                                    >
                                        ...
                                        <span className="text-[11px]">
                                            Add reference image · paste or drag
                                            &amp; drop
                                        </span>
                                    </button>
                                )}
...
function GalleryCard({
    ...
    return (
        <div
            // eslint-disable-next-line jsx-a11y/prefer-tag-over-role -- nested delete button prevents using <button>
            role="button"
            tabIndex={0}
            onClick={onClick}
        ...
        >
            ...
            <div className="p-3 space-y-2">
                <p className="text-xs text-foreground/80 leading-snug line-clamp-2 min-h-10">
                    {gen.prompt}
                </p>
...
function GalleryModal({
    ...
    return (
        <Dialog open={!!gen} onOpenChange={open => !open && onClose()}>
            <DialogContent
                className="p-0 gap-0 overflow-hidden flex flex-row max-w-none sm:max-w-none"
                style={{
                    width: 'fit-content',
                    maxWidth: '90vw',
                    height: '90vh'
                            ...
                            <div className="space-y-2.5">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-start justify-between gap-3">
                                        ...
                                        <span className="text-xs text-muted-foreground/80 text-right">
...
function GeneratingPlaceholder() {
    return (
        <div className="flex flex-col items-center gap-5 w-full max-w-lg">
            <div className="w-full aspect-square rounded-2xl bg-linear-to-br from-muted/40 to-muted/10 border border-border flex items-center justify-center relative overflow-hidden">
...
function EmptyState() {
    return (
        <div className="flex flex-col items-center gap-4 select-none">
            <div className="relative w-48 h-48 rounded-2xl border border-dashed border-border/60 bg-linear-to-br from-muted/20 to-transparent flex items-center justify-center">
...
function HistoryThumb({
    ...
    return (
        <div
            // oxlint-disable-next-line jsx_a11y/prefer-tag-over-role -- nested delete button prevents using <button>
            role="button"
            tabIndex={0}
            onClick={onSelect}
