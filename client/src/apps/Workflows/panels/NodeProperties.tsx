...
export default function NodeProperties({
    ...
    return (
        <div className="w-[260px] shrink-0 border-l border-border bg-card/50 flex flex-col overflow-y-auto">
            {/* Header */}
            <div
                className={`px-3 py-3 border-b border-border flex items-center gap-2 ${meta.bg}`}
            >
                <span className={`text-xs font-semibold ${meta.color} flex-1`}>
                    {meta.label} Config
                </span>
                <button
                    onClick={onClose}
                    ...
                    <>
                        ...
                        <Field label="Initial Data (JSON)">
                            <Textarea
                                ...
                                onChange={e =>
                                    set('initial_data', e.target.value)
                                }
                                rows={4}
                ...
                {type === 'cron_trigger' && (
                    <>
                        ...
                        <Field
                            ...
                            hint="Injected as $input on each run"
                        >
                            <Textarea
                                value={d.initial_data || '{}'}
                                onChange={e =>
                        ...
                        <div className="text-[10px] text-rose-400/70 bg-rose-500/5 border border-rose-500/20 rounded p-2">
                            ⏱ Scheduler checks every 30 seconds. Minimum
                    ...
                    <>
                        ...
                        <div className="space-y-1 text-[10px] text-muted-foreground/70 bg-muted/30 rounded p-2">
                            ...
                            <p className="text-green-400/70">
                                ✓ Sandboxed · Worker thread + vm · 5s timeout
                            </p>
                        </div>
                        <Field label="Output Key">
                            <Input
                ...
                {type === 'db_query' && (
                    <>
                        ...
                        <Field
                            ...
                            hint="Use ? placeholders in the query"
                        >
                            <Input
                                value={d.params || '[]'}
