...
function StorySection({ story }: { story: string }) {
    ...
    const visible =
        showToggle && !expanded ? paragraphs.slice(0, 2) : paragraphs;
    ...
    const handleGenerateLore = async () => {
        ...
        try {
            const res = await fetch(
                `/app/api/musicologia/tracks/${detail.track.id}/generate-lore`,
                {
                    method: 'POST'
                }
            );
                ...
                <div className="max-w-4xl mx-auto p-6 flex flex-col gap-6">
                    ...
                    <div className="flex gap-6">
                        ...
                        <div className="flex flex-col justify-end gap-1.5 min-w-0">
                            ...
                            {lore?.tagline && (
                                <p className="text-sm text-purple-400 italic mt-1">
                                    {lore.tagline}
                                </p>
                            )}
                    ...
                    {dna && (
                        <div className="rounded-xl border border-border/30 bg-card/50 p-5">
                            ...
                            <div className="grid grid-cols-2 gap-x-8 gap-y-3">
                                ...
                                <DnaStat
                                    label="Acousticness"
                                    value={dna.acousticness}
                                    icon={Guitar}
                                    percent
                                />
                                <DnaStat
                                    label="Instrumentalness"
                                    value={dna.instrumentalness}
                                    percent
                                />
                                <DnaStat
                                    label="Liveness"
                    ...
                    {!hasLore && !generatingLore && (
                        <div className="rounded-xl border border-dashed border-purple-500/20 p-6 flex flex-col items-center gap-3 text-center">
                            ...
                            <p className="text-sm text-muted-foreground">
                                No lore yet. Generate AI-powered narrative
