    ...
    <div className="flex-1 overflow-y-auto">
      <div className="max-w-xl mx-auto px-8 py-10">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h2 className="text-lg font-semibold">Marble Studio Settings</h2>
            <p className="text-sm text-muted-foreground">Configure your World Labs API access</p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-border/60 bg-card overflow-hidden">
          <div className="px-5 py-4 border-b border-border/50">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              ...
              . Stored locally in your workspace database and never leaves your server.
            </p>
          </div>
          ...
          <div className="px-5 py-5 space-y-4">
            {loadingStatus ? (
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 rounded-lg bg-green-500/5 border border-green-500/20 px-4 py-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm font-mono font-medium tracking-wider">{status.keyHint}</p>
                  </div>
                </div>
                <p className="text-xs text-muted-foreground">
                  To replace your key, paste a new one below and save.
                </p>
              </div>
            ) : (
              <div className="flex items-center gap-2 rounded-lg bg-amber-500/5 border border-amber-500/20 px-4 py-3 text-sm text-amber-600">
                ...
                <span>No API key configured — world generation is disabled.</span>
              </div>
            )}

            <div className="space-y-2">
              <Label htmlFor="api-key-input">
                {status.hasKey ? "Replace Key" : "Enter API Key"}
              </Label>
