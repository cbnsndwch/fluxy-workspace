                ...
                return (
                    ...
                    >
                        ...
                        <div className="w-[60px] h-[60px] rounded-md overflow-hidden bg-purple-500/5 border border-border/30 shrink-0">
                            {item.album_art ? (
                                <img src={item.album_art} alt={item.album_name ?? ''} className="w-full h-full object-cover" />
                            ) : (
        ...
        <div className="space-y-6">
            ...
            {plays.length < total && (
                <div className="flex justify-center pt-2">
                    ...
                    >
                        {loadingMore ? <><Loader2 className="h-3.5 w-3.5 mr-1.5 animate-spin" />Loading…</> : 'Load more'}
                    </Button>
                </div>
            )}
        </div>
