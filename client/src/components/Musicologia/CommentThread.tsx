        ...
        <div className={depth > 0 ? 'ml-8 mt-3' : 'mt-4'}>
            <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-white/60 leading-relaxed whitespace-pre-wrap">{comment.body}</p>
...
export function CommentThread({
    ...
    const postComment = useCallback(async (body: string, parentId: number | null = null) => {
