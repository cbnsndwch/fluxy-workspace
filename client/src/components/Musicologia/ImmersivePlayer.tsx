            ...
            {lrcPreview.length > 0 && (
              <div className="rounded-lg bg-white/5 border border-white/10 p-3 max-h-40 overflow-y-auto">
                ...
                {lrcPreview.length > 10 && (
                  <p className="text-xs text-white/30 mt-1">+{lrcPreview.length - 10} more…</p>
                )}
              </div>
            )}
...
export default function ImmersivePlayer() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      if (subtitleRef.current)
        exitTl.to(subtitleRef.current, { y: -40, opacity: 0, duration: 1 }, 0.15);
      if (taglineRef.current)
        exitTl.to(taglineRef.current, { y: -20, opacity: 0, duration: 0.6 }, 0.4);
      ...
      if (overlayRef.current)
        exitTl.fromTo(overlayRef.current, { opacity: 0 }, { opacity: 0.7, duration: 0.4 }, 0.6);
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center px-6 max-w-5xl w-full">
          ...
          {/* Artist */}
          <div ref={subtitleRef} className="mt-6 flex flex-col items-center gap-2">
            <p
          ...
          {lore?.tagline && (
            <div ref={taglineRef} className="mt-8 flex flex-col items-center gap-4 w-full max-w-lg">
              <div
      ...
      <section className="relative z-10 py-16 px-6 pb-32">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8">
            ...
            {!user && <p className="text-center text-xs text-white/20 mt-3">Sign in to react</p>}
          </div>
  ...
  return (
    <h2 className="text-xs font-semibold text-white/30 uppercase tracking-[0.25em] flex items-center gap-3">
      <span
        ...
        style={{ maxWidth: "2rem", background: "rgba(255,255,255,0.08)" }}
      />
      {children}
      <span
        className="flex-1 h-px"
        style={{ maxWidth: "100%", background: "rgba(255,255,255,0.08)" }}
      />
    </h2>
  );
}
