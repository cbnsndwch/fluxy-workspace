...
export const NODE_REGISTRY: Record<WorkflowNodeType, NodeMeta> = {
    ...
    cron_trigger: {
        ...
        accent: '#f43f5e',
        icon: 'Clock',
        defaultConfig: { label: 'Scheduled', schedule: '0 * * * *', initial_data: '{}' } as import('./types').CronTriggerConfig,
    },
    http_request: {
        label: 'HTTP Request',
        ...
        accent: '#3b82f6',
        icon: 'Globe',
        defaultConfig: { url: '', method: 'GET', headers: '{}', body: '', output_key: 'response' } as import('./types').HttpRequestConfig,
    },
    code: {
        label: 'Code',
    ...
    transform: {
        ...
        accent: '#f97316',
        icon: 'Zap',
        defaultConfig: { expression: 'input', output_key: 'transformed' } as import('./types').TransformConfig,
    },
    condition: {
        label: 'Condition',
    ...
    db_query: {
        ...
        accent: '#14b8a6',
        icon: 'Database',
        defaultConfig: { query: 'SELECT * FROM workflows LIMIT 10', params: '[]', output_key: 'db_result' } as import('./types').DbQueryConfig,
    },
    log: {
        label: 'Log',
