          ...
          <ScrollArea className="flex-1">
            <div className="px-5 py-4 space-y-5">
              ...
              <div className="space-y-2">
                ...
                {referenceImage ? (
                  ...
                  >
                    ...
                    <span className="text-[11px]">
                      Add reference image · paste or drag &amp; drop
                    </span>
                  </div>
                )}
                ...
                <p className="text-[11px] text-muted-foreground/60 text-right">⌘↵ to generate</p>
              </div>
                  ...
                  {MODELS.map((m) => (
                    ...
                    >
                      <span
                        className={cn(
                          "transition-colors",
                          model === m.value ? "text-primary" : "text-muted-foreground/60",
                        )}
                      >
                        {m.icon}
                      </span>
                  ...
                  {model === "dall-e-3" && (
                    <>
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <Select
                          value={quality}
                          onValueChange={(v) => setQuality(v as DalleQuality)}
                        >
                          <SelectTrigger className="h-8 text-xs w-44">
                            <SelectValue />
                          </SelectTrigger>
  ...
  return (
    <Dialog open={!!gen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent
        ...
        style={{ width: "fit-content", maxWidth: "90vw", height: "90vh" }}
      >
        ...
        <div className="w-80 flex-none flex flex-col border-l border-border overflow-hidden">
          ...
          <div className="p-4 border-t border-border space-y-2">
            <Button className="w-full gap-2" onClick={() => onRemix(gen)}>
              <RefreshCw size={13} />
              Remix
            </Button>
            <Button variant="outline" className="w-full gap-2" onClick={() => onDownload(gen)}>
              <Download size={13} />
              Download
            </Button>
            <Button
