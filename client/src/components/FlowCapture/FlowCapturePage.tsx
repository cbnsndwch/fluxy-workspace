          ...
          <div className="flex items-center gap-1.5">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                <DropdownMenuItem className="cursor-pointer" onClick={() => setShowSample(true)}>
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 py-10 text-center px-2">
                    ...
                    {inputMode === "voice" && isListening && (
                      <p className="text-xs text-muted-foreground/60 leading-relaxed">
                        Complete ideas are extracted automatically — fragments stay in the input
                        below.
                      </p>
                    )}
                  </div>
      ...
      <Dialog open={showSample} onOpenChange={setShowSample}>
        <DialogContent className="max-w-xl [&>button]:cursor-pointer">
          <DialogHeader>
            ...
            <DialogDescription>
              A realistic user-flow walkthrough. Hit <strong>Start Recording</strong> first, then
              read at a natural pace. Pauses between sentences become separate segments.
            </DialogDescription>
          </DialogHeader>
          ...
          <p className="text-xs text-muted-foreground pt-1">
            💡 Speak naturally — complete ideas are auto-segmented, and the diagram updates live as
            you go.
          </p>
