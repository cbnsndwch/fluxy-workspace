import { ArrowRight, GitBranch, Layers, Loader2, Plus, Trash2 } from "lucide-react";
            ...
            <div className="flex flex-col items-center justify-center gap-5 py-20 text-center">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1 max-w-sm">
                  Start a session to capture a conversation and watch it become a diagram in real
                  time.
                </p>
              </div>
              <Button
